...
public void chkAutoFile_clicked1(GCheckbox source, GEvent event) { //_CODE_:chkAutoFile:322035:
  ...
  doChkAutoFileClicked(source, event);
...
public void chkUnused_clicked1(GCheckbox source, GEvent event) { //_CODE_:chkUnused:542584:
  ...
  doChkSaveUnusedClicked( source, event);
...
public void optDoEstimate_clicked1(GOption source, GEvent event) {
  ...
  doOptDoEstimateClicked( source, event);
}

public void optRuthless_clicked1(GOption source, GEvent event) {
  //println("optRuthless - GOption >> GEvent." + event + " @ " + millis());
  doOptRuthlessClicked( source, event);
}

public void optRecEstPProg_clicked1(GOption source, GEvent event) {
  //println("optRecEstPProg - GOption >> GEvent." + event + " @ " + millis());
  doOptRecEstPProgClicked( source, event);
}
...
public void createGUI() {
  ...
  textfieldGSize.setOpaque(false);
  ...
  textfieldGroupQty.setOpaque(false);
  ...
  textfieldRoundsQTY.setOpaque(false);
  ...
  chkAutoFile = new GCheckbox(this, 762, 120, 206, 20);
  ...
  chkUnused = new GCheckbox(this, 762, 168, 206, 20);
  ...
  optDoEstimate = new GOption(this, 762, 220, 206, 20, "Do A Proportion Estimate");
  ...
  textfieldEstP = new GTextField(this, 762, 244, 80, 20, G4P.SCROLLBARS_NONE);
  ...
  textfieldEstP.setOpaque(false);
  textfieldEstP.addEventHandler(this, "textfieldEstP_change1");
  labelEstP = new GLabel(this, 762, 266, 206, 20);
  ...
  optRecEstPProg = new GOption(this, 762, 290, 206, 20, "File Est. Prop. Progress");
  optRecEstPProg.setIconAlign(GAlign.LEFT, GAlign.CENTER);
  optRecEstPProg.setLocalColorScheme(GCScheme.CYAN_SCHEME);
  optRecEstPProg.setOpaque(false);
  optRecEstPProg.addEventHandler(this, "optRecEstPProg_clicked1");
  optRuthless = new GOption(this, 762, 314, 206, 20, "Run Ruthless");
  optRuthless.setIconAlign(GAlign.LEFT, GAlign.CENTER);
  optRuthless.setLocalColorScheme(GCScheme.CYAN_SCHEME);
  optRuthless.setOpaque(false);
  optRuthless.addEventHandler(this, "optRuthless_clicked1");
}
