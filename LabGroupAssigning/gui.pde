...
public void createGUI() {
  ...
  chkAutoFile = new GCheckbox(this, 832, 118, 137, 30);
  ...
  textfieldAuto = new GTextField(this, 800, 147, 36, 20, G4P.SCROLLBARS_NONE);
  ...
  labelAutoTrials = new GLabel(this, 842, 150, 150, 20);
  //labelAutoTrials.setIcon("CENTER", 1, GAlign.EAST, GAlign.RIGHT, GAlign.MIDDLE);
  labelAutoTrials.setTextAlign(GAlign.LEFT, GAlign.MIDDLE);
